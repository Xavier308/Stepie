...
const ActivityHeatmap = ({ weightEntries = [], dietEntries = [], workoutEntries = [] }) => {
  ...
  const dayLabelWidth = 24; // Increased for more space between labels and grid
  ...
  return (
    <div style={{ width: '100%' }}> {/* Added 100% width container */}
      {/* Heatmap Card */}
      <div style={{ 
        backgroundColor: '#fff', 
        ...
        marginTop: '1rem', // FIX #1: Added top margin to separate from the title
        marginBottom: '2.5rem' // FIX #4: Added bottom margin to separate from plus button
      }}>
        {/* FIX #3: Center the grid better with adjusted padding */}
        <div style={{ 
          display: 'flex', 
          ...
          <div>
            ...
            <div style={{ 
              display: 'flex', 
              paddingLeft: `${dayLabelWidth}px`, // FIX #2: Increased padding for the month labels
            ...
            <div style={{ display: 'flex' }}>
              {/* FIX #2: Weekday labels with increased spacing and better alignment */}
              <div style={{ 
                width: dayLabelWidth,
                display: 'flex', 
                ...
                {['', 'Mon', '', 'Wed', '', 'Fri', ''].map((lbl, idx) => (
                  <div key={idx} style={{ 
                    ...
                    display: 'flex',
                    alignItems: 'center',
                    justifyContent: 'flex-end' // Right-align the day labels
                  }}>
                    {lbl}
                  </div>
                ))}
                      ...
                      return (
                        <div
                          ...
                          style={{ 
                            ...
                            height: cellSize, 
                            borderRadius: 2, 
                            backgroundColor: d ? colors[intensity] : 'transparent' 
                          }}
                        />
                      );
                    })}
